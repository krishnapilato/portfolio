    ...
    return [
      {
        ...
        description: 'Comprehensive backend solutions with Spring Boot and Java for scalable, secure applications.',
        delay: 100,
      },
      {
        ...
        description: 'Expert in dynamic, responsive web applications with Angular and TypeScript.',
        delay: 200,
      },
      {
        ...
        description: 'Proficient in building RESTful APIs and interactive UIs with JavaScript and Node.js.',
        delay: 300,
      },
      {
        title: 'AWS & Cloud',
        ...
        description: 'Skilled in cloud-based deployment and scalability solutions using AWS.',
        delay: 400,
      },
      {
        title: 'Databases',
        ...
        description: 'Experienced in relational and NoSQL databases, including MySQL, MongoDB, and PostgreSQL.',
        delay: 500,
      },
    ];
  }
    ...
    return [
      {
        ...
        summary: 'Developed a scalable backend for an e-commerce platform, handling 5000+ users daily.',
      ...
      },
      {
        ...
        summary: 'Built a system to streamline inventory tracking and order management, reducing errors by 40%.',
      ...
      },
      {
        ...
        summary: 'Developed analytics features for tracking and visualizing social media metrics in real-time.',
      ...
      },
      {
        ...
        summary: 'Led integration of third-party banking APIs, enabling seamless mobile transactions.',
