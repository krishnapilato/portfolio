...
/** Ball-joint socket under the case; the mount's ball touches its underside. */
export const SOCKET = { radius: 0.13, height: 0.1, y: -1.58 } as const;
...
export const GLASS = { radius: 1.5, thickness: 0.06, z: 1.13 } as const;
